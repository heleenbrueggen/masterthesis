...
# Saving
write_rds(coverage.datasets_stan4bart, file = paste(path, "results/evaluations/coverage_datasets_stan4bart.rds", sep = ""))
write_rds(coverage_stan4bart, file = paste(path, "results/evaluations/coverage_stan4bart.rds", sep = ""))
write_rds(mcse_coverage_stan4bart, file = paste(path, "results/evaluations/mcse_coverage_stan4bart.rds", sep = ""))
# CIW
...
# Saving
write_rds(ciw.datasets_stan4bart, file = paste(path, "results/evaluations/ciw_datasets_stan4bart.rds", sep = ""))
write_rds(ciw_stan4bart, file = paste(path, "results/evaluations/ciw_stan4bart.rds", sep = ""))