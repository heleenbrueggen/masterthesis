...
results_bart <- list()
for (i in seq_len(nrow(combinations))) {
  results_bart[[i]] <- read_rds(paste("results/imputed/bart/analyses_bart_", names[i], ".rds", sep = ""))
}
#####################################
...
# Saving
write_rds(bias.datasets_bart, file = "results/evaluations/bias_datasets_bart.rds")
write_rds(bias_bart, file = "results/evaluations/bias_bart.rds")
write_rds(mcse_bias_bart, file = "results/evaluations/mcse_bias_bart.rds")
# MSE 
...
# Saving
write_rds(mse.datasets_bart, file = "results/evaluations/mse_datasets_bart.rds")
write_rds(mse_bart, file = "results/evaluations/mse_bart.rds")
write_rds(mcse_mse_bart, file = "results/evaluations/mcse_mse_bart.rds")
# Coverage
...
# Saving
write_rds(coverage.datasets_bart, file = "results/evaluations/coverage_datasets_bart.rds")
write_rds(coverage_bart, file = "results/evaluations/coverage_bart.rds")
write_rds(mcse_coverage_bart, file = "results/evaluations/mcse_coverage_bart.rds")
#CIW
...
# Saving
write_rds(ciw.datasets_bart, file = "results/evaluations/ciw_datasets_bart.rds")
write_rds(ciw_bart, file = "results/evaluations/ciw_bart.rds")
