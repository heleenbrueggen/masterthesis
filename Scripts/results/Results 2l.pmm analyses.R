...
results_2l.pmm <- list()
for (i in seq_len(nrow(combinations))) {
  results_2l.pmm[[i]] <- read_rds(paste("results/imputed/2l.pmm/analyses_2l.pmm_", names[i], ".rds", sep = ""))
}
#####################################
...
# Saving
write_rds(bias.datasets_2l.pmm, file = "results/evaluations/bias_datasets_2l.pmm.rds")
write_rds(bias_2l.pmm, file = "results/evaluations/bias_2l.pmm.rds")
write_rds(mcse_bias_2l.pmm, file = "results/evaluations/mcse_bias_2l.pmm.rds")
# MSE 
...
# Saving
write_rds(mse.datasets_2l.pmm, file = "results/evaluations/mse_datasets_2l.pmm.rds")
write_rds(mse_2l.pmm, file = "results/evaluations/mse_2l.pmm.rds")
write_rds(mcse_mse_2l.pmm, file = "results/evaluations/mcse_mse_2l.pmm.rds")
# Coverage
...
# Saving
write_rds(coverage.datasets_2l.pmm, file = "results/evaluations/coverage_datasets_2l.pmm.rds")
write_rds(coverage_2l.pmm, file = "results/evaluations/coverage_2l.pmm.rds")
write_rds(mcse_coverage_2l.pmm, file = "results/evaluations/mcse_coverage_2l.pmm.rds")
...
# Saving
write_rds(ciw.datasets_2l.pmm, file = "results/evaluations/ciw_datasets_2l.pmm.rds")
write_rds(ciw_2l.pmm, file = "results/evaluations/ciw_2l.pmm.rds")