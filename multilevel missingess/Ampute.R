# DATA AMPUTATION SCRIPT
#####################################################
# This script "amputes" data according to univariate 
# MAR, MCAR or MNAR missingness mechanisms
#####################################################
# USED TERMS
#####################################################
# data		The data in matrix or data-frame format
# mis.var	The column specifier (number) for the 
#			variable to be amputed.
# cov.var	The column specifier (number) for the 
#			covariate the MAR missingness is based on
# prop.mis	Proportion of missingness
# m.mech	The missingness mechanism. Options are 
#			c("MARleft", "MARright", "MARmid", 
#			"MARtail", "MCAR") 
#####################################################

ampute <- function(data, mis.var, cov.var, prop.mis, m.mech="MARleft"){
