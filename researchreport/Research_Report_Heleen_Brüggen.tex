...
% MCAR means that the cause of the missing data are unrelated to the data, Missing At Random (MAR) means that it is related to observed data and Missing Not At Random (MNAR) means that it is related to unobserved data \citep{buurenFlexibleImputationMissing2018, rubin1976}.
