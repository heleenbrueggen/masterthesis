...
\label{eq:population}
\begin{align}
    y_{ij} &= \beta_{0j} + \sum_{k=1}^{7}\beta_{kj}X_{kij} + \epsilon_{ij}, \tag{4} \\
    \beta_{0j} &= \gamma_{00} + \sum_{q=1}^{2}\gamma_{0q}Z_{qj} + \upsilon_{0j}, \tag{4.1} \\
    \beta_{kj} &= \gamma_{k0} + \sum_{q=1}^{2}\gamma_{kq}Z_{qj} + \upsilon_{kj}, \tag{4.2} \\
    \epsilon_{ij} &\sim \mathcal{N}(0, 25), \tag{4.3}
\end{align}
\end{subequations}
