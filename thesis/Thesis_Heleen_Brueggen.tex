...
6155 \\ %detex thesis/Thesis_Heleen_Brueggen.tex | wc -w
...
\begin{enumerate}
    \item r reference
    \item specifications in BART functions
\end{enumerate}
