...
Looking at the residual variance, listwise deletion is the only method that is acceptable biased for all -- or any -- condition. All other imputation methods routinely overestimate the residual variance. Stan4bart has the best performance follow by 2l.PMM, BART, PMM, and R-BART, in that order. Overall, the bias seems to be markedly consistent across all conditions. 
