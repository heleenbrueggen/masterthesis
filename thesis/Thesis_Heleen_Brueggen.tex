...
\begin{align}
y_{ij} &= \beta_{0j} + \beta_{1j}X_{1ij} + \beta_{2j}X_{2ij} + \beta_{3j}X_{3ij} + \beta_{4j}X_{4ij} + \beta_{5j}X_{5ij} + \beta_{6j}X_{6ij} + \beta_{7j}X_{7ij} + \epsilon_{ij}, \\
\beta_{0j} &= \gamma_{00} + \gamma_{01}Z_{1j} + \upsilon_{0j}, \\
\beta_{1j} &= \gamma_{10} + \gamma_{11}Z_{1j} + \upsilon_{1j}, \\
\beta_{2j} &= \gamma_{20} + \gamma_{21}Z_{1j} + \upsilon_{2j}, \\
\beta_{3j} &= \gamma_{30} + \gamma_{32}Z_{2j} + \upsilon_{3j}, \\
\beta_{4j} &= \gamma_{40} + \upsilon_{4j}, \\
\beta_{5j} &= \gamma_{50} + \upsilon_{5j}, \\
\beta_{6j} &= \gamma_{60} + \upsilon_{6j}, \\
\beta_{7j} &= \gamma_{70}, 
\end{align}
...
\label{eq:population}
\begin{align}
    y_{ij} &= \beta_{0j} + \sum_{k=1}^{7}\beta_{kj}X_{kij} + \epsilon_{ij}, \hspace{3cm} X_{kij} \sim \mathcal{N}(0, \mathbf{\Sigma}_{x}), \hspace{.2cm} \epsilon_{ij} \sim \mathcal{N}(0, 25), \\
    &\hspace{.5cm}\beta_{0j} = \gamma_{00} + \sum_{q=1}^{2}\gamma_{0q}Z_{qj} + \upsilon_{0j}, \\
    &\hspace{.5cm}\beta_{kj} = \gamma_{k0} + \sum_{q=1}^{2}\gamma_{kq}Z_{qj} + \upsilon_{kj}, \hspace{2cm} Z_{qj} \sim \mathcal{N}(0, \mathbf{\Sigma}_{z}), \hspace{.2cm} \mathbf{\upsilon}_{j} \sim \mathcal{N}(0, \mathbf{T}), \\
